...
const updateToRedById = `-- name: UpdateToRedById :exec
UPDATE users
SET is_chirpy_red = TRUE, updated_at = NOW()
WHERE id = $1
`

func (q *Queries) UpdateToRedById(ctx context.Context, id uuid.UUID) error {
	_, err := q.db.ExecContext(ctx, updateToRedById, id)
	return err
}
